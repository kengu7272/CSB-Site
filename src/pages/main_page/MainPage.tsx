...
function Reviews() {
  return (
      <div className="w-[84%] h-fit flex flex-col justify-center my-[10%] mx-[8%]">
          <h3 className="text-base">Listen to what they have to say:</h3>
          <p className="my-[2.5%] text-xs">All reviews are from reputable sources that have interacted with the business in the past.</p>
